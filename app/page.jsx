      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-slate-300 mb-2">
            Market Data Date <span className="text-slate-500 font-normal">(select the trading day you want to analyze)</span>
          </label>
          <input
            type="date"
            value={pulseDate}
          ...
          <p className="text-xs text-slate-500 mt-1">
            Defaults to yesterday. Data will show closing prices and % changes for this date.
          </p>
        </div>
