...
export default function Home() {
  ...
  const consolidate = async () => {
    ...
    try {
      ...
      setStatus('Step 1/4: Extracting data from sources...');
      ...
      // Step 2: Compare data and find consensus
      setStatus('Step 2/4: Comparing data & finding consensus...');
      ...
      setStatus('Step 3/4: Synthesizing Morning Pulse (with thinking)...');
      ...
      setStatus('Step 4/4: Verifying closing prices...');
          ...
          <div className="mt-8 bg-slate-800/50 border border-slate-700 rounded-lg p-6">
            ...
            <div className="mt-6 pt-4 border-t border-slate-700">
              ...
              <p className="text-sm text-slate-400 space-y-1">
                <span className="block"><strong className="text-slate-300">Step 1:</strong> Extract numerical data from each source into structured format</span>
                <span className="block"><strong className="text-slate-300">Step 2:</strong> Compare data across sources, identify consensus vs outliers (with thinking)</span>
                <span className="block"><strong className="text-slate-300">Step 3:</strong> Synthesize Morning Pulse using consensus data only (with thinking)</span>
                <span className="block"><strong className="text-slate-300">Step 4:</strong> Verify key closing prices via Google Search</span>
              </p>
            </div>
          </div>
        )}
