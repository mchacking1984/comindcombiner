...
export default function Home() {
  ...
  const consolidate = async () => {
    ...
    try {
      // Step 1: Consolidate
      setStatus('Step 1/2: Consolidating sources with Gemini 2.5 Pro...');
      ...
      if (!consolidateResponse.ok) {
        throw new Error(consolidateData.error || `API request failed: ${consolidateResponse.status}`);
      }
      ...
      setStatus('Step 2/2: Verifying key market data (BTC, S&P 500, Gold, Oil)...');
          ...
          <div className="mt-8 bg-slate-800/50 border border-slate-700 rounded-lg p-6">
            ...
            <div className="mt-6 pt-4 border-t border-slate-700">
              ...
              <p className="text-sm text-slate-400">
                <strong className="text-slate-300">Step 1:</strong> Gemini 2.5 Pro consolidates the three sources using majority rule for conflicts.<br />
                <strong className="text-slate-300">Step 2:</strong> Verification pass searches for closing prices on the specific date (BTC, S&P 500, Gold, Oil) and corrects any errors.
              </p>
            </div>
          </div>
        )}
