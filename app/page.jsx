...
export default function Home() {
  ...
  const consolidate = async () => {
    ...
    try {
      setStatus('Synthesizing Morning Pulse (with extended thinking)...');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
            <div className="bg-emerald-700 px-4 py-2">
              ...
              <p className="text-xs text-emerald-200">News narrative & events</p>
            </div>
            <textarea
              value={chatgptInput}
          ...
          <div className="bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
            <div className="bg-blue-700 px-4 py-2">
              ...
              <p className="text-xs text-blue-200">Quantitative & cross-asset flows</p>
            </div>
            <textarea
              value={geminiInput}
          ...
          <div className="bg-slate-800 rounded-lg border border-slate-700 overflow-hidden">
            <div className="bg-orange-700 px-4 py-2">
              ...
              <p className="text-xs text-orange-200">Regime analysis & non-consensus</p>
            </div>
            <textarea
              value={claudeInput}
        ...
        {!output && !loading && (
          <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
            ...
            <div className="mt-6 pt-4 border-t border-slate-700">
              <h4 className="font-medium text-slate-200 mb-2">How Each Source Is Used</h4>
              <ul className="text-sm text-slate-400 space-y-2">
                <li><strong className="text-emerald-400">ChatGPT:</strong> News narrative, events, single-stock moves → Surfaces "what happened"</li>
                <li><strong className="text-blue-400">Gemini:</strong> Quantitative flows, cross-asset transmission → Explains "how it connected"</li>
                <li><strong className="text-orange-400">Claude:</strong> Regime analysis, non-consensus takes → Drives "The Real Driver" and "What We've Learned"</li>
              </ul>
            </div>

            <div className="mt-4 pt-4 border-t border-slate-700">
              <h4 className="font-medium text-slate-200 mb-2">Why This Works Better</h4>
              <p className="text-sm text-slate-400">
                The Prompt Generator already verified market data and embedded it in each prompt. 
                All three LLMs used the same verified numbers, so there's no need to fact-check. 
                This consolidator just synthesizes the analysis — one API call instead of six.
              </p>
            </div>
          </div>
        )}
