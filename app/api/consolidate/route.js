...
const ASSETS = {
  ...
  'US 2-Year Yield': { yahoo: '^IRX', category: 'FIXED INCOME', isYield: true },
};
...
• **Bitcoin** [USE VERIFIED BITCOIN FIGURE — THIS IS CRITICAL].
• **Ethereum** [USE VERIFIED ETHEREUM FIGURE].
...
export async function POST(request) {
  try {
    ...
    const { step, formattedDate, targetDate } = body;
